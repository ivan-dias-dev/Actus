        ...
        <div className={Style.main}>
            <div className={Style.menu}>
                <div className={Style.secaoPai}>
                    ...
                    <p className={Style.aboutText}> Na TDS Tecnologia, Desenvolvimento e Sistemas LTDA, acreditamos que a tecnologia é a chave para impulsionar negócios e transformar ideias em realidade. Somos uma empresa especializada no desenvolvimento de soluções inovadoras, focadas em otimizar processos e maximizar resultados.</p>
